...
# - 존재하지 않으면 에러 응답
@app.get("/select_manufacturer/{item_id}")
...
async def insert_one( manufacturer: Manufacturer
    # TODO: Form 파라미터 정의
    ...
    try:
        ...
        # TODO: SQL 작성
        sql = """
            INSERT INTO Manufacturer (mname) 
            VALUES (%s)
        """
...
@app.delete("/delete_manufacturer/{item_id}")
...
if __name__ == "__main__":
    import uvicorn
    print(f"🚀 manufacturer API 서버 시작")
